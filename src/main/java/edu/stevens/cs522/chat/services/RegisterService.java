...
public class RegisterService extends Service {
    ...
    public static final String CHAT_NAME_KEY = "edu.stevens.cs522.chat.rest.extra.CHAT_NAME";
    ...
    public static void register(Context context, Uri serverUri, String chatName, ResultReceiver receiver) {
        ...
        intent.putExtra(SERVER_URL_KEY, serverUri.toString());
    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
         ...
         */
        final Uri serverUrl = intent.getData();
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        notificationManager.notify(registerNotificationId, notificationBuilder.build());
